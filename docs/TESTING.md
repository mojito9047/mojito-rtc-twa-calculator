...
| `test_install.py` | `copy_previous_install.py`: finding the most recently used earlier version, copying settings, state and uploaded files, v60-style state in the app folder, not copying over a version used since, answering no. |
